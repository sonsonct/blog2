...
export class PostsService {
    ...
    async createPost(postData: CreateCategoryDTO) {
        try {
    ...
    async updatePost(id: number, postData: CreateCategoryDTO) {
        try {
    ...
    async findPostsByTitle(dataSearch: SearchPostDTO) {
        try {
    ...
    async findPostByHashTag(hashtagId: SearchHashtagPostDTO) {
